...
#   set_location_assignment PIN_B12 -to CLOCK_50_2 ;# Global Clock 9
   ...
   set_location_assignment PIN_H2 -to sclr ;# KEY0/BUTTON0 (right button covered)
   set_location_assignment PIN_G3 -to dec ;# KEY1/BUTTON1 (mid button - half covered)
   set_location_assignment PIN_F1 -to inc ;# KEY2/BUTTON2 (left button)
...
#   set_location_assignment PIN_J1 -to o1 ;# LEDG[0]
#   set_location_assignment PIN_J2 -to t2 ;# LEDG[1]
#   set_location_assignment PIN_J3 -to t3 ;# LEDG[2]
...
#   set_location_assignment PIN_A18 -to HEX2_DP  ;# DP 
   ...
   set_location_assignment PIN_F14 -to H[6] ;# g  HEX2S[0]
   set_location_assignment PIN_B17 -to H[5] ;# f  HEX2S[1]
   set_location_assignment PIN_A17 -to H[4] ;# e  HEX2S[2]
   set_location_assignment PIN_E15 -to H[3] ;# d  HEX2S[3]
   set_location_assignment PIN_B16 -to H[2] ;# c  HEX2S[4]
   set_location_assignment PIN_A16 -to H[1] ;# b  HEX2S[5]
   set_location_assignment PIN_D15 -to H[0] ;# a  HEX2S[6]


#   set_location_assignment PIN_G16 -to HEX3_DP  ;# DP 

   set_location_assignment PIN_G15 -to TH[6] ;# g  HEX3S[0]
   set_location_assignment PIN_D19 -to TH[5] ;# f  HEX3S[1]
   set_location_assignment PIN_C19 -to TH[4] ;# e  HEX3S[2]
   set_location_assignment PIN_B19 -to TH[3] ;# d  HEX3S[3]
   set_location_assignment PIN_A19 -to TH[2] ;# c  HEX3S[4]
   set_location_assignment PIN_F15 -to TH[1] ;# b  HEX3S[5]
   set_location_assignment PIN_B18 -to TH[0] ;# a  HEX3S[6]
