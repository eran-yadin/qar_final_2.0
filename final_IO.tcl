...
#   set_location_assignment PIN_B12 -to CLOCK_50_2 ;# Global Clock 9
   ...
   set_location_assignment PIN_H2 -to B[0] ;# KEY0/BUTTON0 (right button covered)
   set_location_assignment PIN_G3 -to B[1] ;# KEY1/BUTTON1 (mid button - half covered)
   set_location_assignment PIN_F1 -to B[2] ;# KEY2/BUTTON2 (left button)
   ...
   set_location_assignment PIN_J6 -to S[0] ;# SW[0]
   set_location_assignment PIN_H5 -to S[1] ;# SW[1]
   set_location_assignment PIN_H6 -to S[2] ;# SW[2]
   set_location_assignment PIN_G4 -to S[3] ;# SW[3]
   set_location_assignment PIN_G5 -to S[4] ;# SW[4]
   set_location_assignment PIN_J7 -to S[5] ;# SW[5]
   set_location_assignment PIN_H7 -to S[6] ;# SW[6]
   set_location_assignment PIN_E3 -to S[7] ;# SW[7]
   set_location_assignment PIN_E4 -to S[8];# SW[8]
   set_location_assignment PIN_D2 -to S[9] ;# SW[9]
   ...
   set_location_assignment PIN_J1 -to L_out[0] ;# LEDG[0]
   set_location_assignment PIN_J2 -to L_out[1] ;# LEDG[1]
   set_location_assignment PIN_J3 -to L_out[2] ;# LEDG[2]
   set_location_assignment PIN_H1 -to L_out[3] ;# LEDG[3]
   set_location_assignment PIN_F2 -to L_out[4] ;# LEDG[4]
   set_location_assignment PIN_E1 -to L_out[5] ;# LEDG[5]
   set_location_assignment PIN_C1 -to L_out[6] ;# LEDG[6]
   set_location_assignment PIN_C2 -to L_out[7] ;# LEDG[7]
   set_location_assignment PIN_B2 -to L_out[8] ;# LEDG[8]
   set_location_assignment PIN_B1 -to L_out[9] ;# LEDG[9] 
...
#   set_location_assignment PIN_D13 -to HEX0_DP  ;# DP 
   ...
   set_location_assignment PIN_F13 -to SEG_1[6] ;# g  HEX0S[0]
   set_location_assignment PIN_F12 -to SEG_1[5] ;# f  HEX0S[1]
   set_location_assignment PIN_G12 -to SEG_1[4] ;# e  HEX0S[2]
   set_location_assignment PIN_H13 -to SEG_1[3] ;# d  HEX0S[3]
   set_location_assignment PIN_H12 -to SEG_1[2] ;# c  HEX0S[4]
   set_location_assignment PIN_F11 -to SEG_1[1] ;# b  HEX0S[5]
   set_location_assignment PIN_E11 -to SEG_1[0] ;# a  HEX0S[6]


#   set_location_assignment PIN_B15 -to HEX1_DP  ;# DP 

   set_location_assignment PIN_A15 -to SEG_2[6] ;# g  HEX1S[0]
   set_location_assignment PIN_E14 -to SEG_2[5] ;# f  HEX1S[1]
   set_location_assignment PIN_B14 -to SEG_2[4] ;# e  HEX1S[2]
   set_location_assignment PIN_A14 -to SEG_2[3] ;# d  HEX1S[3]
   set_location_assignment PIN_C13 -to SEG_2[2] ;# c  HEX1S[4]
   set_location_assignment PIN_B13 -to SEG_2[1] ;# b  HEX1S[5] 
   set_location_assignment PIN_A13 -to SEG_2[0] ;# a  HEX1S[6]


#   set_location_assignment PIN_A18 -to HEX2_DP  ;# DP 

   set_location_assignment PIN_F14 -to SEG_3[6] ;# g  HEX2S[0]
   set_location_assignment PIN_B17 -to SEG_3[5] ;# f  HEX2S[1]
   set_location_assignment PIN_A17 -to SEG_3[4] ;# e  HEX2S[2]
   set_location_assignment PIN_E15 -to SEG_3[3] ;# d  HEX2S[3]
   set_location_assignment PIN_B16 -to SEG_3[2] ;# c  HEX2S[4]
   set_location_assignment PIN_A16 -to SEG_3[1] ;# b  HEX2S[5]
   set_location_assignment PIN_D15 -to SEG_3[0] ;# a  HEX2S[6]


#   set_location_assignment PIN_G16 -to HEX3_DP  ;# DP 

   set_location_assignment PIN_G15 -to SEG_4[6] ;# g  HEX3S[0]
   set_location_assignment PIN_D19 -to SEG_4[5] ;# f  HEX3S[1]
   set_location_assignment PIN_C19 -to SEG_4[4] ;# e  HEX3S[2]
   set_location_assignment PIN_B19 -to SEG_4[3] ;# d  HEX3S[3]
   set_location_assignment PIN_A19 -to SEG_4[2] ;# c  HEX3S[4]
   set_location_assignment PIN_F15 -to SEG_4[1] ;# b  HEX3S[5]
   set_location_assignment PIN_B18 -to SEG_4[0] ;# a  HEX3S[6]
