...
#   set_location_assignment PIN_B12 -to CLOCK_50_2 ;# Global Clock 9
   ...
   set_location_assignment PIN_H2 -to P1 ;# KEY0/BUTTON0 (right button covered)
   set_location_assignment PIN_G3 -to CLR ;# KEY1/BUTTON1 (mid button - half covered)
   set_location_assignment PIN_F1 -to P2 ;# KEY2/BUTTON2 (left button)
...
#   set_location_assignment PIN_J6 -to num_1/2 ;# SW[0]
#   set_location_assignment PIN_H5 -to Res_cal ;# SW[1]
#   set_location_assignment PIN_H6 -to Res_1/2 ;# SW[2]
...
#   set_location_assignment PIN_E4 -to sel[1] ;# SW[8]
#   set_location_assignment PIN_D2 -to sel[0] ;# SW[9]
   ...
   set_location_assignment PIN_J1 -to LED[0] ;# LEDG[0]
   set_location_assignment PIN_J2 -to LED[1] ;# LEDG[1]
   set_location_assignment PIN_J3 -to LED[2] ;# LEDG[2]
   set_location_assignment PIN_H1 -to LED[3] ;# LEDG[3]
   set_location_assignment PIN_F2 -to LED[4] ;# LEDG[4]
   set_location_assignment PIN_E1 -to LED[5] ;# LEDG[5]
   set_location_assignment PIN_C1 -to LED[6] ;# LEDG[6]
   set_location_assignment PIN_C2 -to LED[7] ;# LEDG[7]
   set_location_assignment PIN_B2 -to LED[8] ;# LEDG[8]
   set_location_assignment PIN_B1 -to LED[9] ;# LEDG[9] 
...
#   set_location_assignment PIN_F13 -to O[6] ;# g  HEX0S[0]
#   set_location_assignment PIN_F12 -to O[5] ;# f  HEX0S[1]
#   set_location_assignment PIN_G12 -to O[4] ;# e  HEX0S[2]
#   set_location_assignment PIN_H13 -to O[3] ;# d  HEX0S[3]
#   set_location_assignment PIN_H12 -to O[2] ;# c  HEX0S[4]
#   set_location_assignment PIN_F11 -to O[1] ;# b  HEX0S[5]
#   set_location_assignment PIN_E11 -to O[0] ;# a  HEX0S[6]


#   set_location_assignment PIN_B15 -to HEX1_DP  ;# DP 

#   set_location_assignment PIN_A15 -to TE[6] ;# g  HEX1S[0]
#   set_location_assignment PIN_E14 -to TE[5] ;# f  HEX1S[1]
#   set_location_assignment PIN_B14 -to TE[4] ;# e  HEX1S[2]
#   set_location_assignment PIN_A14 -to TE[3] ;# d  HEX1S[3]
#   set_location_assignment PIN_C13 -to TE[2] ;# c  HEX1S[4]
#   set_location_assignment PIN_B13 -to TE[1] ;# b  HEX1S[5] 
#   set_location_assignment PIN_A13 -to TE[0] ;# a  HEX1S[6]


#   set_location_assignment PIN_A18 -to HEX2_DP  ;# DP 

   set_location_assignment PIN_F14 -to seg_num[6] ;# g  HEX2S[0]
   set_location_assignment PIN_B17 -to seg_num[5] ;# f  HEX2S[1]
   set_location_assignment PIN_A17 -to seg_num[4] ;# e  HEX2S[2]
   set_location_assignment PIN_E15 -to seg_num[3] ;# d  HEX2S[3]
   set_location_assignment PIN_B16 -to seg_num[2] ;# c  HEX2S[4]
   set_location_assignment PIN_A16 -to seg_num[1] ;# b  HEX2S[5]
   set_location_assignment PIN_D15 -to seg_num[0] ;# a  HEX2S[6]


#   set_location_assignment PIN_G16 -to HEX3_DP  ;# DP 

   set_location_assignment PIN_G15 -to seg_P[6] ;# g  HEX3S[0]
   set_location_assignment PIN_D19 -to seg_P[5] ;# f  HEX3S[1]
   set_location_assignment PIN_C19 -to seg_P[4] ;# e  HEX3S[2]
   set_location_assignment PIN_B19 -to seg_P[3] ;# d  HEX3S[3]
   set_location_assignment PIN_A19 -to seg_P[2] ;# c  HEX3S[4]
   set_location_assignment PIN_F15 -to seg_P[1] ;# b  HEX3S[5]
   set_location_assignment PIN_B18 -to seg_P[0] ;# a  HEX3S[6]
